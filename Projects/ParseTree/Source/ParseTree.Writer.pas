...
type
  ...
  private
    ...
    procedure WriteEmptyStatement(AStmt: TEmptyStatementSyntax);
...
begin
  ...
  if AStmt is TWhileStatementSyntax then
    ...
    WriteEmptyStatement(TEmptyStatementSyntax(AStmt))
...
procedure TSyntaxTreeWriter.WriteTryStatement(AStmt: TTryStatementSyntax);
var
  LStmt: TStatementSyntax;
begin
  WriteToken(AStmt.TryKeyword);
  for LStmt in AStmt.Statements do
    WriteStatement(LStmt);
  WriteToken(AStmt.FinallyKeyword);
  WriteToken(AStmt.ExceptKeyword);
...
procedure TSyntaxTreeWriter.WriteProcedureCallStatement(AStmt: TProcedureCallStatementSyntax);
var
  LToken: TSyntaxToken;
begin
  for LToken in AStmt.ExpressionTokens do
...
procedure TSyntaxTreeWriter.WriteEmptyStatement(AStmt: TEmptyStatementSyntax);
begin
  WriteToken(AStmt.Semicolon);
end;
