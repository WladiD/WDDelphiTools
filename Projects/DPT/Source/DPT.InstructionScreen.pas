  ...
  begin
    FActions := [
      ...
      TActionInfo.Create('ExeAnalyze', '<ExeFile> [--Format=Text|Json] [--UnitsOnly] [--Index=<file>] [--SortBy=VA|Name|Size]', [
        ...
        '  2. (planned) TD32 debug info embedded in the EXE.',
        '  3. (planned) RTTI scan of TObject-derived classes.',
        'Currently only method 1 is implemented; without a .map file',
        'the unit list comes back empty with a diagnostic note.',
        'Options:',
